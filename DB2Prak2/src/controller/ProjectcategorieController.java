...
/**
 * controller for table "Projektkategorie"
 * 
 ...
 *
 */
public class ProjectcategorieController extends DbController {
	private GridPane grid = null;
	
	// SQL Statements
	private String sql_tableName = "Projektkategorie";
	private String sql_idField = "ProjektkategorieID";
	 ...
	 */
	public ProjectcategorieController(GridPane grid,Databean bean) {
		super(bean);
