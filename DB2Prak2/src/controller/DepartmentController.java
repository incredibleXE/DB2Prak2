...
/**
 * controller for table "Abteilung"
 * 
 ...
 *
 */
public class DepartmentController extends DbController {
	private GridPane grid = null;
	
	// SQL Statements
	private String sql_tableName = "Abteilung";
	private String sql_idField = "AbteilungsID";
	private String sql_select = "SELECT * FROM "+sql_tableName;
	private String sql_newEntry = "INSERT INTO "+sql_tableName+" (Abteilungsname) VALUES ";
	 ...
	 */
	public DepartmentController(GridPane grid,Databean bean) {
		super(bean);
	...
	protected void makeForm() {
		...
		int column = 0;
		{
			...
			{ // column 2
				column++;
				formGrid.add(new Label("Abteilungsname:"), 0, column);
